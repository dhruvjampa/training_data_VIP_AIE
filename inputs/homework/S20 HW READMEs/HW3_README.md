...
Finally, modify the test code to include a plot of the full sweep of the data provided in `inp.txt` for the bin range 1 to 100. Save this plot as `problem1.png`. Your y axis will be the value returned by the `sweepN` function and your x axis will be the range of bins (1 to 100).
